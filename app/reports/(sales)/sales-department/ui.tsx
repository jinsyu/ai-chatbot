    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <h1 className="flex items-center gap-4">
          <span className="text-2xl font-bold ">부서별 매출 실적</span>
          <span className="text-gray-500">42차: 2025.03 ~ 2025.03</span>
        </h1>
        <div className="flex items-center gap-2">
          <Select>
            ...
            <SelectContent>
              <SelectItem value="국내영업">국내영업</SelectItem>
              <SelectItem value="조달">조달</SelectItem>
              <SelectItem value="해외영업">해외영업</SelectItem>
              <SelectItem value="철도사업">철도사업</SelectItem>
              <SelectItem value="SI">SI</SelectItem>
              <SelectItem value="인터랙트">인터랙트</SelectItem>
            </SelectContent>
          </Select>
          <Select>
            <SelectTrigger className="w-[180px]">
